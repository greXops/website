...
const features = [
  {
    title: "DevSecOps and Software",
    imageUrl: "img/Mexican1.svg",
    description: (
      <>
        <p>
        ...
        <p>
          ...
          <a href="https://github.com/benthosdev/benthos-plugin-example">
            directly in Go (recommended)
          </a>{" "}
          or you can configure Benthos to run your plugin as a{" "}
          <a href="/docs/components/processors/subprocess">subprocess</a>.
        </p>
      </>
    ),
  },
    ...
    description: (
      <>
        ...
        <p>
          ...
          rest assured,{" "}
          <a href="https://underthehood.meltwater.com/blog/2019/08/26/enriching-450m-docs-daily-with-a-boring-stream-processor/">
            it's totally drab
          </a>
          .
        </p>
    ...
    description: (
      <>
        ...
        <p>
          ...
          scaling. It also exposes{" "}
          <a href="/docs/components/metrics/about">metrics</a> and{" "}
          <a href="/docs/components/tracers/about">tracing</a> events to targets
          of your choice.
        </p>
      </>
    ),
    ...
    <div className={classnames("col col--4", styles.feature)}>
      {imgUrl && (
        <div className="text--center">
          <img
            className={classnames("padding-vert--sm", styles.featureImage)}
            src={imgUrl}
            alt={title}
          />
        </div>
...
function Home() {
  ...
  return (
    <Layout
      title={"greXops"}
      description="DevSecOps - Test Automation - Performance Testing"
      keywords={[
        "devops",
        "devsecops",
        "test automation",
                ...
                <section className={styles.configSnippets}>
                  ...
                  >
                    {snippets.map((props, idx) => (
                      <TabItem value={props.label} key={idx}>
